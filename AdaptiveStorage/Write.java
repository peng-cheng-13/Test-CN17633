	...
	try{
		String confile = "/home/condor/alluxio/conf/alluxio-site.properties";
        	...
        	Configuration.merge(mypro);
                ...
                StorageTier sTier0 = metaManager.getTier("MEM");
                long freeTier0 = sTier0.getAvailableBytes();
                System.out.println("Mmeory tier available bytes : " + freeTier0);
		...
		FileSystem fs = FileSystem.Factory.get();
	        //AlluxioURI path = new AlluxioURI("/testfile-java1"); //p2mass-atlas-ID00004s-jID00004_area.fits 
	        AlluxioURI path = new AlluxioURI("/p2mass-atlas-ID00004s-jID00004.fits");
