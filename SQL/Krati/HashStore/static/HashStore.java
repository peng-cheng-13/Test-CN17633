...
public class HashStore implements Closeable {
  ...
  protected static SerializableObjectStore<String, Set<String>> PATHSTORE;
  ...
  public static SerializableObjectStore<String, Set<String>> staticDataStore() {
    PATHSTORE = createDataStore(new File("/home/condor/test/SQL/Krati/HashStore/static/PathStore"), 10240);
    return PATHSTORE;
  }
  ...
  protected static SerializableObjectStore<String, Set<String>>
    ...
    try {
    System.out.println("Create static object store once");
